...
def main_program(person_present, code_run):
    ...
    # while (code_run):
        ...
        if(workstation_time[1]>0 and (time.time()-last_time1>1)):
                ...
                check1_f = workstation_time[1] / 10# float devision
                ...
                if(check1_f == check1_int):
                    ...
                    if(pos == 0):
                        if(person_present.value):
                            timeout1 =False
                        elif (not person_present.value and timeout1):
                                
                            # if (0<result[0][0]<150):
                            workstation_user[1] = 1
                            check1 = 0
                            modify_session_time(username1,1,60-workstation_time[1])
                            ...
                            username1=None
                                ...
                                timeout1 =True
                                print(str(timeout1)+"is for 1stworks")
                ...
                if(workstation_time[1]==1 and st1):
                    modify_session_time(username1,1,60)
                    st1 = False
        ...
        elif(workstation_time[2]>0 and (time.time()-last_time2>1)):
                ...
                check2_f = workstation_time[2] / 7# float devision
                ...
                if(check2_f == check2_int):
                    ...
                    if(pos==1):
                        if(person_present.value):
                        ...
                        elif (not person_present.value and timeout2):
                                
                            # if (0<result[0][0]<150):
                            workstation_user[2] = 1
                            check2 = 0
                            modify_session_time(username2,2,60-workstation_time[2])
                            ...
                            timeout2 =False
                                ...
                                timeout2 =True
                                print(str(timeout2)+"is for 2ndworks")
                    
                    
                if(check2 and (check2_time - workstation_time[2] < 3)):
                    if(not GPIO.input(SW4)):
                        check2 = 0
                        GPIO.output(LED,GPIO.LOW)
                elif(check2 and (check2_time - workstation_time[2] >= 3)):
                    workstation_user[2] = 1
                    check2 = 0
                    workstation_time[2] = 0
                    GPIO.output(LED,GPIO.LOW)
                ...
                if(workstation_time[2]==1 and st2):
                    modify_session_time(username2,2,60)
                    st2 = False
